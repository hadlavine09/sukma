...
<main class="app-content">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            ...
            @endif
            <div class="mb-3">
                <a href="{{ route('izin_toko.create') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Tambah Toko</a>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content shadow-sm">
            ...
            <div class="modal-body">
                Apakah Anda yakin ingin <strong id="verif-aksi">menyetujui</strong> toko <strong id="verif-nama"></strong>?
            </div>
