...
<head>
    ...
    <title>Login Penjual - SukMa</title>
...
<section class="py-5">
    <div class="container">
        <div class="row justify-content-center align-items-center g-5">
            ...
            <!-- Left Column -->
            <div class="col-lg-6">
                <h2 class="fw-bold text-dark mb-3">Masuk Sebagai Penjual</h2>
                <p class="text-muted">Kelola toko Anda, pantau pesanan, dan tingkatkan penjualan Anda dengan mudah melalui dashboard penjual kami.</p>
                <ul class="list-unstyled mt-4">
                    <li class="mb-3 d-flex">
                        <i class="bi bi-shop-window text-green fs-4 me-3"></i>
                        <div>
                            <h6 class="fw-semibold mb-1">Kelola Toko Anda</h6>
                            <small class="text-muted">Tambah produk, atur stok dan lihat performa penjualan.</small>
                        </div>
                    </li>
                    <li class="mb-3 d-flex">
                        <i class="bi bi-cart-check text-green fs-4 me-3"></i>
                        <div>
                            <h6 class="fw-semibold mb-1">Kelola Pesanan</h6>
                            <small class="text-muted">Pantau dan proses pesanan pelanggan dengan mudah.</small>
                        </div>
                    </li>
                    <li class="d-flex">
                        <i class="bi bi-graph-up text-green fs-4 me-3"></i>
                        <div>
                            <h6 class="fw-semibold mb-1">Analisa Penjualan</h6>
                            <small class="text-muted">Lihat statistik untuk bantu optimasi penjualan Anda.</small>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-lg-5">
                <div class="card p-4">
                    <h4 class="mb-4 text-center">Login Penjual</h4>
                    <form method="POST" action="/login-penjual">
                        ...
                        <div class="text-center mt-3">
                            <a href="/lupa-password" class="text-decoration-none">Lupa kata sandi?</a>
                        </div>

                        <div class="text-center mt-3">
                            <span>Belum punya akun?</span> <a href="{{ url('/Toko/RegisterToko') }}" class="text-green fw-semibold">Daftar sebagai penjual</a>
                        </div>
                    </form>
                </div>
            </div>
