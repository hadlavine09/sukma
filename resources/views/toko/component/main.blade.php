        ...
        <div class="row justify-content-center align-items-center g-5">
            ...
            <div class="col-lg-6">
                ...
                <ul class="list-unstyled mt-4">
                    <li class="mb-3 d-flex">
                        <i class="bi bi-shop-window text-danger fs-4 me-3"></i>
                        <div>
                    ...
                    <li class="mb-3 d-flex">
                        <i class="bi bi-cart-check text-danger fs-4 me-3"></i>
                        <div>
                    ...
                    <li class="d-flex">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Dapatkan insight mendalam tentang kinerja tokomu.</small>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-lg-5">
                <div class="bg-white p-4 p-md-5 rounded shadow-sm">
                    <h5 class="fw-bold mb-4 text-center text-danger">Login Penjual</h5>
                    <form method="POST" action="#">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label">Email / No. HP</label>
                            <input type="text" class="form-control" name="email" placeholder="Email atau No. HP" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="{{ route('password.request') }}" class="small text-danger">Lupa kata sandi?</a>
                        </div>
