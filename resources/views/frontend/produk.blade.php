...
<script>
    ...
    function tampilkanKategori(kategoriData) {
        ...
        kategoriData.forEach((item, index) => {
           ...
           const linkKategori = `/kategori/${encodeURIComponent(item.nama_kategori)}?kode=${encodeURIComponent(item.kode_kategori)}`;
                                        ...
                                        window.setupProductEvents = function() {
                                            document.querySelectorAll('.product-item').forEach(product => {
                                                ...
                                                addToCartBtn.addEventListener('click', function (e) {
                                                    ...
                                                    $.ajax({
                                                        url: "{{ route('frontend.tambahkeranjang') }}", // ✅ gunakan Laravel route di sini
                                                        type: 'POST',
                                                        headers: {
