...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/nav.png" />
    <!--begin::Fonts-->
...
<body class="img js-fullheight js-fullwidht" width="100%">
    <nav class="shopee-navbar" role="navigation" aria-label="Main navigation">
        <div class="container">
            <div class="navbar-left d-flex align-items-center">
                ...
                <span class="ms-3 fw-bold text-dark" style="font-size: 1.2rem;">Daftar Sebagai UMKM</span>
            </div>
        ...
        <div class="navbar-right d-flex align-items-center" style="gap: 1rem;">
            ...
            <div class="profile-dropdown-wrapper" style="margin-left: 0.5rem;">
                ...
                @else
                    ...
                    <a href="{{ route('umkm.register') }}" class="nav-login" tabindex="0">Daftar sebagai UMKM</a>
                    <span class="mx-1 text-black">|</span>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 copyright">
                    <p>© 2025 Sukma (Sukamukti Market). All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
