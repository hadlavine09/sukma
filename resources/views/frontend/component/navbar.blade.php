        ...
        <div class="container">
            ...
            <div class="navbar-right">
                <div class="nav-cart-dropdown-wrapper position-relative" style="display:inline-block;">
                    <a href="{{ route('frontend.keranjang') }}" class="nav-icon" aria-label="Keranjang Belanja" title="Keranjang Belanja"
                        id="cartDropdownBtn">
                    ...
                    <div id="cartDropdownCard"
                        ...
                        <div class="card-body p-3">
                            ...
                            <a href="{{ route('frontend.keranjang') }}" class="btn btn-primary w-100" id="lihatKeranjangBtn">Lihat
                                Keranjang</a>
                        </div>
                    </div>
                    <script>
